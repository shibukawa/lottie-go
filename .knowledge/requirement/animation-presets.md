...
status:
  - chibi-male shipped: examples/state-editor/presets/chibi-male, generator cmd/lottie-state-editor/genpresets, pose-sequence authoring, preview.png contact sheet, regression tests in cmd/lottie-state-editor/presets_test.go
