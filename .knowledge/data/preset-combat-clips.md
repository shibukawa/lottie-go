...
per_kind:
  ...
  sword_rig:
    ...
    grip_limb_depth: the far FOREARM is moved ahead of the torso too (it folds across the front of the belly onto the hilt); left in the far chain it hides behind the body and the character reads as one-handed with a stump (user feedback 2026-08). The far upper arm stays behind - its elbow is out at the torso's leading edge, the right place to cross from behind the silhouette to in front
