...
consequences:
  - the clip is plain Lottie with a key wherever the motion bends more than a pixel (every frame at the limit): heavy in bytes, trivial to play, editable only in the sense a rendered frame is
