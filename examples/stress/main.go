...
// Usage:
//
//	go run ./examples/stress [-n 5] [-seconds 10]
//
...
var (
	...
	files   = []string{
		"examples/gallery/assets/layers-precomp-nested.json",
		"examples/gallery/assets/properties-bezier-ease.json",
		"examples/gallery/assets/shape-style-gradient-radial.json",
		"examples/gallery/assets/shape-modifiers-trim-simultaneously.json",
		"examples/gallery/assets/layers-matte-above.json",
	}
)
