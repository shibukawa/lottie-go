...
// speak:
//
//	go run -tags ebitenginedebug ./examples/lottie/gpuprobe -copies 20 | go run ./examples/lottie/gpuprobe -summarize
//
...
//
//	go run ./examples/lottie/gpuprobe -golden /tmp/base       # record a baseline
//	go run ./examples/lottie/gpuprobe -compare /tmp/base      # verify against it
//
// Usage:
//
//	go run ./examples/lottie/gpuprobe [-files a.json,b.json] [-copies n] [-frames n]
...
const defaultAssetDir = "examples/lottie/gallery/assets"
