...
The same storyboard as [examples/lottie/cutscene](../cutscene) — a pig late for
...
Inside the repository, `go run ./examples/lottie/motioncomic`, or open the file
in the general player:

    go run ./examples/lottie/player examples/lottie/motioncomic/motioncomic.json
...
Both this command and examples/lottie/player do so.
