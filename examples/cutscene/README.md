...
[examples/motioncomic](../motioncomic).
...
Inside the repository, `go run ./examples/cutscene`, or open the file in
the general player for seeking and speed controls:

    go run ./examples/player examples/cutscene/cutscene.json

Regenerate the JSON with:

    go run ./examples/cutscene/gen
