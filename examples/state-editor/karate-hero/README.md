...
dialog offers stays `examples/state-editor/presets/chibi-male`.
...
Watch it live while editing: `cd cmd/lottie-state-editor && go run . -viewer ../../examples/state-editor/karate-hero/karate-hero.lottie`.
